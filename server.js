...
//check the JWT_SECRET key succesfully added or not
...
// MSSQL configuration(windows authentication)
const config = {
  driver: 'msnodesqlv8',
...
//set default secret key if the key is not available
const jwtSecret = process.env.JWT_SECRET || '123ridmi';
//user login
app.post('/login', async (req, res) => {
  ...
  app.get('/users', async (req, res) => {
    try {
      ...
      //print the all users details in console
